...
?>
   ...
   <?php require_once'menubar.php';?>
      <div class="col-md-10 col-md-offset-1" style="background-color: #DAEEEA">
	  <br><br>
	  <h2 style="font-family:Bernard MT Condensed; color:#06857C;">Admin Teacher</h2>
		 ...
		 <a href = "teacher_logout.php" class="btn btn-warning" style="float:right;">Sign Out</a>
            <div class="panel-body">
				<center><p>Welcome - <?php echo "<b style='font-family:Bodoni MT Condensed;color:#053BC2; font-size:30px;'>".$login_session."</b>"; ?></p>
					<p>you can update noitce</p>
				</center><br><br>
